...
class ExchangeRateServiceTest {
    ...
    void testUpdateDollarExchangeRate_Weekend() {
    ...
    void testUpdateDollarExchangeRate_Weekday_Success() {
    ...
    void testUpdateDollarExchangeRate_Weekday_EmptyResponse() {
    ...
    void testExchangeRateService_ExceptionHandling() {
    ...
    void testUpdateDollarExchangeRate_Exception() {
